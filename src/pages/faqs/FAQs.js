        ...
        <div className="codeutsava__section7" id="faq">
          ...
          <div className="codeutsava__section7-body">
            <div className="codeutsava__section7-left">
              ...
              ></img>
              <div
                className={`codeutsava__section7-left-answer-container answer-animation ${
                  answerId === -1 ? `answer-hidden` : ``
                }`}
              >
                <p className="codeutsava__section7-left-answer">{answer}</p>
              </div>
            ...
            <div className="codeutsava__section7-right">
              <div className="codeutsava__section7-right-upper">
                ...
                <p>
                  New to hackathon? <br /> Don't worry we got you covered with
              ...
              <div className="codeutsava__section7-right-question-container">
                <ul>
                  {faqs.map((faq, index) => (
                    <p
                      className="codeutsava__section7-right-question"
                      key={index}
                      onClick={() => fetchQ(index)}
                    >
                      {faq.question}
                    </p>
                  ))}
